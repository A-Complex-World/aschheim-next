export default function Datenschutz() {
  return (
    <main className="bg-sand text-ink min-h-screen px-5 md:px-8 py-24 max-w-3xl mx-auto">
      ...
      <h1 className="display text-6xl md:text-7xl leading-[1] mb-12">Datenschutz</h1>
      <div className="space-y-6 text-ink-soft leading-relaxed text-base">
        {[
          { n: "01", t: "Verantwortlicher", b: "DB Development GmbH · Musterstraße 1 · 80333 München · Deutschland · next@db-development.de" },
