export default function Impressum() {
  return (
    <main className="bg-sand text-ink min-h-screen px-5 md:px-8 py-24 max-w-3xl mx-auto">
      ...
      <h1 className="display text-6xl md:text-7xl leading-[1] mb-12">Impressum</h1>
      <div className="space-y-6 text-ink-soft leading-relaxed text-base">
        <div className="card p-6">
          <div className="mono text-[10px] tracking-[0.14em] uppercase text-ink-mute mb-2">Anbieter / Bauherr</div>
          <div className="display text-2xl text-ink">DB Development GmbH</div>
          <div>Musterstraße 1 · 80333 München · Deutschland</div>
        </div>
        <div className="card p-6">
          <div className="mono text-[10px] tracking-[0.14em] uppercase text-ink-mute mb-2">Architektur & Planung</div>
          <div className="display text-2xl text-ink">Steiner Architektur</div>
          <div>München · Deutschland</div>
        </div>
        <div className="card p-6">
          <div className="mono text-[10px] tracking-[0.14em] uppercase text-ink-mute mb-2">Kontakt</div>
          <div>E-Mail: <a href="mailto:next@db-development.de" className="link-u text-ink">next@db-development.de</a></div>
        ...
        <div className="card p-6">
          ...
          <div className="text-ink">Geschäftsführung DB Development GmbH</div>
        </div>
        <div className="card p-6">
